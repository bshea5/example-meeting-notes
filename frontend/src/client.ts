// Code generated by the Encore v1.25.2 client generator. DO NOT EDIT.
...
export function Environment(name: string): BaseURL {
  return `https://${name}-meeting-notes-rh6i.encr.app`;
}
...
/**
 * Client is an API client for the meeting-notes-rh6i Encore application.
 */
export default class Client {
  public readonly note: note.ServiceClient;
  public readonly pexels: pexels.ServiceClient;
  ...
  constructor(target: BaseURL, options?: ClientOptions) {
    ...
    this.pexels = new pexels.ServiceClient(base);
  }
}
...
export namespace pexels {
  ...
  export class ServiceClient {
    ...
    public async SearchPhoto(_query: string): Promise<SearchResponse> {
      ...
      const resp = await this.baseClient.callAPI(
        "GET",
        `/images/${encodeURIComponent(_query)}`
      );
...
class BaseClient {
  ...
  constructor(baseURL: string, options: ClientOptions) {
    ...
    this.headers = {
      ...
      "User-Agent": "meeting-notes-8ami-Generated-TS-Client (Encore/v1.25.2)",
    };
